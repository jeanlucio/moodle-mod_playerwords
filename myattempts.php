...
/**
 * A student's own round history for a PlayerWords instance. The all-students report
 * lives at attemptsreport.php instead, gated by its own dedicated capability.
 *
