...
$string['attemptsreport_bulkdeletebutton'] = 'Delete selected';
$string['attemptsreport_bulkdeleteconfirm'] = 'Are you sure you want to delete the selected attempts? This action cannot be undone.';
$string['attemptsreport_bulkdeletetitle'] = 'Delete attempts';
$string['attemptsreport_deleteattempt'] = 'Delete attempt';
$string['attemptsreport_deleteattemptconfirm'] = 'Are you sure you want to delete this attempt? This action cannot be undone.';
$string['attemptsreport_empty'] = 'No student has finished a round yet.';
$string['attemptsreport_huditemsnotremoved'] = 'PlayerHUD items granted for winning are not removed when an attempt is deleted. To revoke them, use the PlayerHUD block\'s own management screen.';
$string['attemptsreport_selectall'] = 'Select all';
...
$string['cell_state_empty_position'] = 'Empty — letter {$a->position} of {$a->total}';
...
$string['event_attempt_deleted'] = 'Attempt deleted';
...
$string['glossary_split_concepts'] = 'Split multi-word concepts';
$string['glossary_split_concepts_help'] = 'When checked, a multi-word glossary concept (e.g. "Operating System") is split into separate single-word candidates (e.g. "Operating" and "System"), growing the word pool. When unchecked (default), that concept is not added to the pool at all — neither split nor whole, since a candidate word can never contain a space. Unchecked favours clue quality: the isolated words of a split concept do not always make sense as a word to guess on their own.';
...
$string['help_accents'] = 'On the game\'s on-screen keyboard, hold down a key that has accented variants (most vowels, plus C, N and S) to open the popup and drag to the one you want — accenting is optional, the game recognizes the word even without one.';
$string['help_attempts'] = 'You have a limited number of attempts per round, shown at the top of the board.';
$string['help_gradescoringmode'] = 'Grade scoring mode: {$a}. In Binary mode, you get full credit for winning the round no matter how many attempts you use. In Linear mode, the first two attempts both earn full credit, and each attempt after that lowers your credit.';
...
$string['help_keyboard'] = 'You can also type using your device\'s physical keyboard — each letter you type moves you to the next box automatically.';
...
$string['help_rankingscoringmode'] = 'Ranking scoring mode: {$a}. In Binary mode, you earn full points for winning the round no matter how many attempts you use. In Linear mode, the first two attempts both earn full points, and each attempt after that lowers your points.';
...
$string['hints_enabled'] = 'Allow hints';
$string['hints_enabled_help'] = 'When enabled (default), students can reveal the round\'s hint, if the picked word has one configured. When disabled, the reveal-hint button never appears, even for words that have a hint.';
$string['hintsdisabled'] = 'Hints are disabled for this activity.';
...
$string['hud_notinstalled_desc'] = 'The block_playerhud plugin is not installed on this site. Install it, then add the PlayerHUD block to a course, to let teachers reward students with items for PlayerWords rounds.';
$string['hud_notinstalled_heading'] = 'PlayerHUD integration';
$string['hud_outdated_desc'] = 'The block_playerhud plugin is installed, but on a version older than v1.7.1, which this integration requires. Update block_playerhud to let teachers reward students with items for PlayerWords rounds.';
...
$string['lobby_gradesummary'] = 'Worth up to {$a->points} points — {$a->scoringmode}.';
...
$string['playerwords:deleteattempts'] = 'Delete PlayerWords student attempts';
$string['playerwords:managewords'] = 'Manage the PlayerWords word pool';
$string['playerwords:view'] = 'View PlayerWords activity';
$string['playerwords:viewreports'] = 'View every student\'s PlayerWords attempt report';
...
$string['privacy:metadata:playerwords_words:hint'] = 'Optional hint text for the word.';
$string['privacy:metadata:playerwords_words:playerwordsid'] = 'ID of the PlayerWords activity.';
$string['privacy:metadata:playerwords_words:source'] = 'Where the word came from: manual entry, glossary sync or AI generation.';
$string['privacy:metadata:playerwords_words:timecreated'] = 'Time when the word was added.';
$string['privacy:metadata:playerwords_words:word'] = 'The word text itself.';
...
$string['ranking_scoringexplanation'] = 'Ranking points always use a base of 100. {$a}';
$string['ranking_scoringexplanation_binary'] = 'In Binary mode, you earn all 100 points for winning the round no matter how many attempts you use.';
$string['ranking_scoringexplanation_linear'] = 'In Linear mode, the first two attempts both earn full points, and each attempt after that lowers your points.';
...
$string['rankingscoringmode_help'] = 'Determines how many points a single round contributes to the ranking total: <ul><li><strong>Binary:</strong> 100 points (the ranking\'s own fixed base) if the round was won, regardless of how many attempts were used; zero otherwise.</li><li><strong>Linear:</strong> the first two attempts both earn the full 100 points; from the third attempt onward, won rounds contribute a fraction of those 100 points proportional to attempts spared — the fewer attempts used, the more points earned.</li></ul> Ranking points always use this fixed base, completely independent of the grade — this works the same way whether or not the activity uses grading at all. Locked once the activity has at least one finished attempt.';
$string['rankingscoringmode_locked'] = 'Because this activity has at least one finished attempt, the ranking scoring mode can no longer be changed — changing it afterwards would make past and future rounds count toward the ranking on different scales. This applies even if grading or the ranking display is currently turned off, since ranking points are always computed and stored for every finished round.';
$string['recentwordslabel'] = 'Word pool';
$string['resetplayerwordsattempts'] = 'Delete PlayerWords round attempts';
$string['restrict_guess_pool'] = 'Restrict guesses to the word pool';
$string['restrict_guess_pool_help'] = 'When enabled, a guess is only accepted if it matches one of the words already approved in this activity\'s own pool — any other letter combination of the right length is rejected without using up an attempt. When disabled (the default), any letter combination of the right length is accepted, even if it is not a real word.';
...
$string['roundinprogress'] = 'A round is already available for you. Play it before requesting a new one.';
...
$string['scoringmode_locked'] = 'Because this activity has already recorded a real grade for at least one student, the maximum attempts, the word pool restriction and the grade scoring mode can no longer be changed — changing them afterwards would make past and future rounds unfairly easier or harder to compare.';
