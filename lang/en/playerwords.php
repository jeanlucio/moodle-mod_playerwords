...
$string['scoringmode_locked'] = 'Because this activity has already recorded a real grade for at least one student, the maximum attempts, the word pool restriction and the two scoring mode settings can no longer be changed — changing them afterwards would make past and future rounds unfairly easier or harder to compare.';
