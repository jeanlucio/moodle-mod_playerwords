...
$string['privacy:metadata:external:usagereport_fields'] = 'Aggregate, non-personal site and activity statistics (e.g. Moodle/PHP version, country, language, platform, plugin version, approximate active student count, number of course instances, installed companion plugins, internal error counters).';
$string['privacy:metadata:external:usagereport_summary'] = 'To help prioritise development, this plugin periodically sends anonymous, aggregate usage statistics to the developer\'s own telemetry service. No personal data is included.';
...
$string['taskusagereport'] = 'Send anonymous usage report';
...
$string['usagereport'] = 'Send anonymous usage statistics';
$string['usagereport_desc'] = 'Periodically sends anonymous, aggregate statistics about this activity\'s use — site info (Moodle/PHP version, country, language, platform), usage (plugin version, approximate number of active students, number of course instances, installed companion plugins), and internal error counters — to the developer\'s telemetry service, to help prioritise fixes and improvements. No personal data is included. Disable this to stop sending reports.';
