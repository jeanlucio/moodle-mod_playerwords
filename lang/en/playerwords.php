...
$string['completionmingradegroup'] = 'Require minimum grade';
...
$string['error_completionmingrade'] = 'Minimum grade must be greater than 0.';
$string['error_completionmingrade_max'] = 'Minimum grade must be less than or equal to maximum grade.';
...
$string['recentwordslabel'] = 'Recent words';
$string['roundfinished'] = 'This round is already finished. Start a new round.';
$string['roundlost'] = 'Round finished. You can start a new round.';
