...
$string['completionattempts'] = 'Required attempts for completion';
$string['completionheader'] = 'Completion settings';
$string['completiontype'] = 'Completion mode';
$string['completiontype_attempts'] = 'Complete after a number of attempts';
$string['completiontype_grade'] = 'Complete after reaching minimum grade';
$string['completiontype_view'] = 'Complete on view';
$string['error_atleastonesource'] = 'Select at least one word source.';
$string['error_completionattempts'] = 'Completion attempts must be at least 1.';
...
$string['mod/playerwords:addinstance'] = 'Add a new PlayerWords activity';
$string['mod/playerwords:view'] = 'View PlayerWords activity';
