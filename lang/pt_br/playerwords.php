...
$string['gradescoringmode_help'] = 'Define quantos pontos uma rodada vale, antes da agregação da nota ser aplicada: <ul><li><strong>Binária:</strong> a nota cheia da atividade se a rodada foi vencida, independente da quantidade de tentativas; nota zero caso contrário.</li><li><strong>Linear:</strong> rodadas vencidas valem uma fração da nota cheia proporcional às tentativas poupadas — quanto menos tentativas usadas, mais pontos. Uma rodada que usou o máximo de tentativas permitido ainda ganha alguns pontos; não completar a rodada sempre vale zero.</li></ul> Trava assim que a atividade registrar uma nota real para algum estudante.';
...
$string['rankingscoringmode_help'] = 'Define quantos pontos uma rodada contribui para o total do ranking: <ul><li><strong>Binária:</strong> a nota cheia da atividade se a rodada foi vencida, independente da quantidade de tentativas; nota zero caso contrário.</li><li><strong>Linear:</strong> rodadas vencidas contribuem com uma fração da nota cheia proporcional às tentativas poupadas — quanto menos tentativas usadas, mais pontos.</li></ul> Trava assim que a atividade registrar uma nota real para algum estudante, para manter todas as rodadas comparáveis na mesma escala.';
