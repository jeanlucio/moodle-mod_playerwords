...
$string['completionattempts'] = 'Tentativas exigidas para conclusão';
$string['completionheader'] = 'Configurações de conclusão';
$string['completiontype'] = 'Modo de conclusão';
$string['completiontype_attempts'] = 'Concluir após um número de tentativas';
$string['completiontype_grade'] = 'Concluir ao atingir a nota mínima';
$string['completiontype_view'] = 'Concluir ao visualizar';
$string['error_atleastonesource'] = 'Selecione ao menos uma fonte de palavras.';
$string['error_completionattempts'] = 'As tentativas para conclusão devem ser no mínimo 1.';
