...
$string['help_keyboard'] = 'Você também pode digitar usando o teclado físico do seu dispositivo.';
...
$string['myattempts_empty_report'] = 'Nenhum estudante concluiu uma rodada ainda.';
$string['myattempts_filterbutton'] = 'Filtrar';
$string['myattempts_rankingpoints'] = 'Pontos no ranking';
$string['myattempts_report_title'] = 'Registro de tentativas — Todos os estudantes';
...
$string['scoringmode_locked'] = 'Como esta atividade já registrou uma nota real para pelo menos um estudante, o máximo de tentativas e os dois modos de pontuação não podem mais ser alterados — mudar isso depois faria rodadas antigas e novas valerem em escalas diferentes.';
